...
6. *.pth: Files related to trained RL model. These files are generated at the end of training using the execution of Training_DS.py file.       


Execution: 
1. Download the files   
2. cd to the folder at the location of the downloaded files
3. Run $python Training_DS_Old_Reward.py
...
6. Run $python Expt_Old_Reward.py
